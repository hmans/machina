...
- Write documentation for scanning as well as completeness. Keep one main idea per paragraph, split multi-stage behavior under descriptive subheadings, and prefer short bullets for sets of responsibilities, constraints, or fields. Do not hide multi-system explanations inside one table cell or an unbroken paragraph; keep the inventory row concise and move detailed relationships into a nearby section.
