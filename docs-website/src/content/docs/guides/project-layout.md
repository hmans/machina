...
Project-owned source assets live under `assets/`. UUID-backed resource files declare:

- `scrapbot.texture` for PNG images;
- `scrapbot.environment` for Radiance HDR environments;
- `scrapbot.model` for static glTF and GLB models.
