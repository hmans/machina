...
| `machina render [--editor] [--select entity-id] [--frames N] [--width PX] [--height PX] [path] [output.png]` | Render one or more offscreen frames to a PNG artifact. |
| `machina render-test [--editor] [--select entity-id] [--frames N] [--width PX] [--height PX] [path] [output.png]` | Render and verify visible output. |
| `machina visual-test [--editor] [--select entity-id] [--frames N] [--width PX] [--height PX] [--update] <path> <expected.png> [actual.png]` | Render and compare a golden visual fixture. |
...
- `--width PX` and `--height PX` set the offscreen output size in positive integer pixels.
