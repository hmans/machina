...
**Tradeoff:** Gizmo rendering is currently simple screen-space strokes projected from world-space axes. Local-space handles, rotation/scale modes, snapping, hover styling before press, occlusion behavior, and a broader editor transaction model are not covered yet.
