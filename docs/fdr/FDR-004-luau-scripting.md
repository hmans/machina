...
- The engine registry contains built-in transform, camera, geometry, material, ambient-light, directional-light, point-light, and internal render-instance component names.
