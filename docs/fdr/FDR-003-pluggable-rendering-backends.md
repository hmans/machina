...
SSR performs a bounded current-frame view-space ray march and fades uncertain, distant, rough, and screen-edge hits.

TAA jitters the projection and camera-reprojects the composed result into retained color/depth history. Resize, world replacement, depth replacement, camera cuts, and TAA mode changes reject history. Culling stays unjittered.
