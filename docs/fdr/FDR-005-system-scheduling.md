...
- Deferred commands currently support spawning named entities with initial Transform, Geometry, Material, Point Light, shadow-marker, public UI, and schema-backed component payloads; despawning entities without shifting existing entity indices; and adding/removing supported engine or project components.
