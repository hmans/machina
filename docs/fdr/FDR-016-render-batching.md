...
**Decision:** The first batching key is built-in primitive parameters plus base-color material data.
**Why:** These are the render states Machina currently supports, and they map cleanly to shared vertex/index buffers plus per-instance transforms and colors. This follows FDR-015.
...
- **FDRs:** FDR-007, FDR-008, FDR-009, FDR-015
