...
**Tradeoff:** The single-world model cannot preserve an unsaved authoring world alongside an independently running play world. A structurally rewritten entity block uses canonical TOML formatting, and runtime-generated resources are not automatically promoted into project resource declarations.
