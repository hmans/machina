...
- While the shell is visible, every non-editor camera entity with a valid world Transform is represented in the scene viewport by a compact wireframe camera body and lens. The visualization follows parented world transforms, highlights the selected camera, and excludes the separate editor-owned fly camera.
