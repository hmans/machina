...
- [x] Retain render extraction across frames and update existing GPU batches from dirty instance slots without full active-set scans or draw-database rebuilds.
