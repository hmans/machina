...
- [x] Odin `test` can discover test projects, validate test manifests, replay script-visible input resources, execute Luau-backed frame simulation, and evaluate first-pass field assertions.
...
- [ ] Port retained UI/editor input routing for Odin test replay, including scroll and command-event assertions.
