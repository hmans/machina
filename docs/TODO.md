...
- [ ] Complete the project-local Odin native host API, including vec3/string/structural callbacks, development-time source rebuild/load, reload diagnostics, and replacement of the Zig native reload path.
