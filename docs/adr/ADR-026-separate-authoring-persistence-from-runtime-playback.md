...
- Reloading or reverting from the scene file must be a separate explicit destructive operation rather than an implicit meaning of Stop; that control is not included in the current slice.
