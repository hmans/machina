...
17. Port first-pass test command discovery, manifest validation, field assertion execution, and script-visible input resource replay while retained UI/editor input routing and native-backed fixtures still wait for their Odin ports.
