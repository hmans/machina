...
The environment importer validates 2:1 Radiance HDR panoramas and precomputes renderer-ready linear diffuse-irradiance and roughness-prefiltered specular cube maps. An authored scene environment component selects Environment UUIDs and presentation values as established by ADR-038; no environment conversion or resource scan runs in ordinary frames.
