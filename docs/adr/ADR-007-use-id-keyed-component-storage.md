...
Luau component handles expose both `name` and `id`. Systems may still declare access by handle or registered component name, but runtime queries and deferred project-component mutations use the component ID to find the matching storage group.
