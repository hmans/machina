...
After setup, `mise scrapbot run examples/gltf-showcase --editor` renders the pinned Khronos Damaged Helmet through the real glTF importer and WGPU material path.
