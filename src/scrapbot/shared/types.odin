...
Camera_Component :: struct {
	...
	automatic_exposure_max: f32,
	automatic_exposure_speed: f32,
...
World_Entity :: struct {
	...
	render_dirty: bool,
	render_extract_dirty: bool,
	render_transform_dirty: bool,
	ui_dirty: bool,
...
Render_List :: struct {
	...
	instance_index_by_entity: [dynamic]int,
	instance_index_by_slot: [dynamic]int,
	dirty_instance_slots: [dynamic]int,
	dirty_transform_slots: [dynamic]int,
...
World :: struct {
	...
	render_extract_dirty_entities: [dynamic]int,
	render_transform_dirty_entities: [dynamic]int,
