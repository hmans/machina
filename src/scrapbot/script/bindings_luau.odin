...
foreign luau {
	...
	luau_compile :: proc "c" (source: cstring, size: c.size_t, options: ^Compile_Options, out_size: ^c.size_t) -> rawptr ---
	luau_load :: proc "c" (L: Lua_State, chunkname: cstring, data: rawptr, size: c.size_t, env: c.int) -> c.int ---
	...
	lua_pushcclosurek :: proc "c" (L: Lua_State, fn: Lua_CFunction, debugname: cstring, nup: c.int, cont: rawptr) ---
