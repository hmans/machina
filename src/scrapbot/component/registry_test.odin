...
test_registry_contains_engine_components :: proc(t: ^testing.T) {
	...
	testing.expect(t, camera.field_count == 13)
	testing.expect(t, camera.fields[4].name == "automatic_exposure")
	testing.expect(t, camera.fields[8].name == "temporal_antialiasing")
	testing.expect(t, camera.fields[11].name == "screen_space_reflections")
	testing.expect(t, camera.fields[12].name == "bloom")
	...
	testing.expect(t, fog.field_count == 9)
	...
	testing.expect(t, fog.fields[8].name == "point_light_intensity")
