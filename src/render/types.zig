...
pub const render_ui_button_state_component_id = "machina.render.internal.ui.button_state";
pub const render_ui_clip_component_id = "machina.render.internal.ui.clip";
pub const render_draw_batch_component_id = "machina.render.internal.draw.batch";
pub const render_draw_ui_component_id = "machina.render.internal.draw.ui";
pub const render_extract_system_id = "machina.render.extract";
pub const render_prepare_meshes_system_id = "machina.render.prepare_meshes";
pub const render_queue_meshes_system_id = "machina.render.queue_meshes";
pub const render_interact_ui_system_id = "machina.render.interact_ui";
pub const render_prepare_ui_system_id = "machina.render.prepare_ui";
pub const render_queue_ui_system_id = "machina.render.queue_ui";
pub const render_draw_meshes_system_id = "machina.render.draw_meshes";
...
pub const editor_command_play_toggle = "machina.editor.play_toggle";
pub const editor_command_step = "machina.editor.step";
pub const editor_command_splitter_left = "machina.editor.splitter.left";
pub const editor_command_splitter_right = "machina.editor.splitter.right";
...
pub const editor_inspector_line_stride: f32 = 28.0;
pub const editor_inspector_field_row_stride: f32 = 32.0;
pub const editor_inspector_card_gap: f32 = 0.0;
pub const editor_inspector_separator_height: f32 = 1.0;
pub const editor_inspector_card_padding_x: f32 = 16.0;
pub const editor_inspector_card_padding_y: f32 = 16.0;
pub const editor_inspector_field_value_column_x: f32 = 204.0;
pub const editor_inspector_field_column_gap: f32 = 8.0;
pub const editor_inspector_input_padding_x: f32 = 4.0;
pub const editor_inspector_input_gap: f32 = 6.0;
pub const editor_inspector_input_height: f32 = 28.0;
pub const editor_inspector_input_corner_radius: f32 = 5.0;
